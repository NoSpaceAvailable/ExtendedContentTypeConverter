package burp;/*
 * @(#)burp.IInterceptedProxyMessage.java
 *
 ...
 * <code>burp.IProxyListener</code> to receive details of proxy messages using this
 * interface. *
 */
public interface IInterceptedProxyMessage
{
     ...
     *
     * @return An <code>burp.IHttpRequestResponse</code> object containing details of
