package burp;/*
 * @(#)burp.IMessageEditorTabFactory.java
 *
 ...
 * <code>burp.IBurpExtenderCallbacks.registerMessageEditorTabFactory()</code> to
...
public interface IMessageEditorTabFactory
{
     ...
     * <code>burp.IMessageEditorTab</code> object.
     *
     * @param controller An
     * <code>burp.IMessageEditorController</code> object, which the new tab can query
     ...
     * read-only.
     * @return A new
     * <code>burp.IMessageEditorTab</code> object for use within the message editor.
     */
