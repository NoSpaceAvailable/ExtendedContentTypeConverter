 ...
 *
 * Extensions can call
 * <code>burp.IBurpExtenderCallbacks.getHelpers</code> to obtain an instance of this
 * interface.
 */
public interface IExtensionHelpers
{
     ...
     *
     * @param request An
     * <code>burp.IHttpRequestResponse</code> object containing the request to be
     * analyzed.
     * @return An
     * <code>burp.IRequestInfo</code> object that can be queried to obtain details
     * about the request.
     */
     ...
     * <code>burp.IRequestInfo</code> object will not include the full request URL.
     ...
     * @return An
     * <code>burp.IResponseInfo</code> object that can be queried to obtain details
     * about the response.
     */
     ...
     * @return An
     * <code>burp.IParameter</code> object that can be queried to obtain details
     ...
     * @param parameter An
     * <code>burp.IParameter</code> object containing details of the parameter to be
     ...
     * <code>burp.IHttpService</code> object based on the details provided.
     *
    ...
    /**
     * This method constructs an
     * <code>burp.IParameter</code> object based on the details provided.
     *
     * @param name The parameter name.
     * @param value The parameter value.
     * @param type The parameter type, as defined in the
     * <code>burp.IParameter</code> interface.
     * @return An
     * <code>burp.IParameter</code> object based on the details provided.
     */
    ...
    /**
     * This method constructs an
     * <code>burp.IScannerInsertionPoint</code> object based on the details provided.
