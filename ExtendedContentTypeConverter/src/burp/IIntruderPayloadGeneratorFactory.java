package burp;/*
 * @(#)burp.IIntruderPayloadGeneratorFactory.java
 *
 ...
 * <code>burp.IBurpExtenderCallbacks.registerIntruderPayloadGeneratorFactory()</code>
...
public interface IIntruderPayloadGeneratorFactory
{
     ...
     *
     * @param attack An
     * <code>burp.IIntruderAttack</code> object that can be queried to obtain details
     * about the attack in which the payload generator will be used.
     * @return A new instance of
     * <code>burp.IIntruderPayloadGenerator</code> that will be used to generate
