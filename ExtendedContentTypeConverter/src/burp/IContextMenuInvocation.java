package burp;/*
 * @(#)burp.IContextMenuInvocation.java
 *
 ...
 * <code>burp.IContextMenuFactory</code> with details of a context menu invocation.
...
public interface IContextMenuInvocation
{
     ...
     * panel, then the
     * <code>burp.IHttpRequestResponse</code> returned by this method will reflect
     ...
     * <code>burp.IHttpRequestResponse</code> at the time of invocation, or you
     * should use
     * <code>burp.IBurpExtenderCallbacks.saveBuffersToTempFiles()</code> to create a
     * persistent read-only copy of the
     * <code>burp.IHttpRequestResponse</code>.
     *
     * @return An array of <code>burp.IHttpRequestResponse</code> objects
     ...
     *
     * @return An array of <code>burp.IScanIssue</code> objects representing the
