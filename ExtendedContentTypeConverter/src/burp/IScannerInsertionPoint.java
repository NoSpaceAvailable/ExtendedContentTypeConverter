package burp;/*
 * @(#)burp.IScannerInsertionPoint.java
 *
 ...
 * <code>burp.IScannerCheck</code>, or can create instances for use by Burp's own
 * scan checks by registering an
 * <code>burp.IScannerInsertionPointProvider</code>.
 */
