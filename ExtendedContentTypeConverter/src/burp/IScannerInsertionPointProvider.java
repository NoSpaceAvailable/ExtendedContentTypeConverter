package burp;/*
 * @(#)burp.IScannerInsertionPointProvider.java
 *
 ...
 * <code>burp.IBurpExtenderCallbacks.registerScannerInsertionPointProvider()</code>
...
public interface IScannerInsertionPointProvider
{
     ...
     * scanned.
     * @return A list of
     * <code>burp.IScannerInsertionPoint</code> objects that should be used in the
     * scanning, or
