 ...
 * <code>burp.IBurpExtenderCallbacks.registerScannerCheck()</code> to register a
...
public interface IScannerCheck
{
     ...
     * @return A list of <code>burp.IScanIssue</code> objects, or <code>null</code>
     ...
     * <code>burp.IScannerInsertionPoint</code> object provided to build scan
     ...
     * @param baseRequestResponse The base HTTP request / response that should
     * be actively scanned.
     * @param insertionPoint An <code>burp.IScannerInsertionPoint</code> object that
